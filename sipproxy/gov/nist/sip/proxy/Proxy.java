        ...
        if (confFile == null) {
            ...
            try {
                ...
                if (configuration == null || !configuration.isValidConfiguration()) {
                    ...
                    throw new Exception("ERROR: the configuration file is not correct!" +
                        " Correct the errors first.");
                } else {
                ...
                if (presenceServer.isStateAgent(request)) {
                    ...
                    if (targetURIList == null) {
                        ...
                        ProxyDebug.println("Proxy: received a Subscribe request to " +
                            ...
                            " responded 404");
                        Response response =
                            messageFactory.createResponse(Response.NOT_FOUND, request);
                        if (serverTransaction != null)
    ...
    public void processTimeout(TimeoutEvent timeOutEvent) {
        ...
        if (timeOutEvent.isServerTransaction()) {
            ...
            if (dialog != null) {
                ...
                if (st == null) {
                    ProxyDebug.println("ERROR, Unable to retrieve the server transaction," +
                        " cannot process timeout!");
                    return;
                }
            } else {
                ProxyDebug.println("ERROR, Unable to retrieve the transaction Mapping," +
                    " cannot process timeout!");
                return;
            }
        ...
        if (configuration != null && configuration.isValidConfiguration()) {
            ...
            for (int i = 0; lps != null && i < lps.size(); i++) {
                ...
                try {
                    ...
                    ListeningPoint lp = sipStack.createListeningPoint(Integer.valueOf(a.port).intValue(),
                        a.transport);
